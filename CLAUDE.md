...
| 指标 | 当前值 | 备注 |
|---|---|---|
| 正确性测试 | 通过 | 远程 commit `595d5e4`，`taskset 0-31` |
| case 1 speedup | 45.447x | 两次正式运行中值，1024x4096x1024 |
| case 2 speedup | 66.266x | 两次正式运行中值，2048x2048x2048 |
| case 3 speedup | 572.374x | 两次正式运行中值，10240x1024x10240，5% 稀疏 |
| case 4 speedup | 16.045x | 两次正式运行中值，8192x8x8192 |
| 加权端到端 speedup | 143.235x | 两次正式输出 143.878x / 142.591x 的中值，权重 2:2:2:4 |
